...
В целом, его логика максимально простая: при наличии списка прокси, на вызов запроса мы отдаем адрес прокси, если прокси недоступен или по каким-то причинам через него нельзя достучаться до ресурса, мы почемаем прокси недоступным и выдаем следующий или None.
